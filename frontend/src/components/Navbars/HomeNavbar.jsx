...
import homeNavbarStyle from "assets/jss/material-dashboard-react/components/homeNavbarStyle.jsx";
      ...
      <List className={classes.list}>
        <ListItem className={classes.listItem}>
          <NavLink to={"/auth/Home"} className={classes.navLink}>
            <Menu className={classes.listItemIcon} />
            <ListItemText
              primary={"Home"}
        ...
        <ListItem className={classes.listItem}>
          <NavLink
            ...
            className={cx(classes.navLink, {
              [classes.navLinkActive]: this.activeRoute("/admin/dashboard")
            })}
          >
